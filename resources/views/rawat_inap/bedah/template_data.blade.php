...
<div class="col-span-12 mb-3  box">
    <div class="flex items-center col-span-12 border-b border-slate-200/60 dark:border-darkmode-400 px-3 py-2 text-left bg-warning rounded-t-lg justify-between"
        ...
        <a href="javascript:;" class="font-medium text-white w-full text-xl">Ruang Bedah</a>
    ...
    <div class="grid grid-cols-12 gap-6 modal-parent  p-8">
        ...
        <div class="col-span-12 md:col-span-8 grid grid-cols-12 gap-4 parent_hewan disabled">
            <div class="col-span-6">
                ...
                <input type="text" class="form-control" readonly name="name" value="{{ $data->owner->name }}">
...
<div class="col-span-12 md:col-span-9 box p-8">
    ...
    <ul class="nav nav-link-tabs flex-col sm:flex-row justify-center lg:justify-start text-center overflow-y-scroll disable-scrollbars"
        ...
        <li id="tindakan-bedah-data-tab" class="nav-item" role="presentation">
            <a href="javascript:;" class="nav-link py-4 flex items-center active justify-center  w-full md:w-52"
        ...
        <li id="history-data-tab" class="nav-item" role="presentation">
            <a href="javascript:;" class="nav-link py-4 flex items-center w-full md:w-52 justify-center"
    ...
    <div class="tab-content mt-5 overflow-y-auto" style="max-height: 525px !important">
        <div id="history-data" class="tab-pane leading-relaxed " role="tabpanel" aria-labelledby="example-1-tab">
        ...
        <form id="tindakan-bedah-data" class="tab-pane leading-relaxed active" role="tabpanel"
            aria-labelledby="example-2-tab">
            <table class="w-full table table-bordered">
                <thead align="center">
                    ...
                    <th>Status Tindakan Bedah</th>
                </thead>
                <tbody>
                    @forelse ($rm->RekamMedisRekomendasiTindakanBedah->sortByDesc('created_at') as $i => $item)
                        @if ($item->status == 'Released')
                            <tr>
                                <td>
                                    {{ $item->Tindakan->name }}
                                    <input type="hidden" class="id_bedah" name="id_bedah[]"
                                        value="{{ $item->id }}">
                                </td>
                                    ...
                                    <div class="mt-3">
                                        <div class="flex flex-col sm:flex-row mt-2">
                                            <div class="form-check mr-6">
                                                <input id="radio-switch-{{ $item->id }}-4"
                                                    class="form-check-input" type="radio"
                                                    name="status_{{ $item->id }}" value="Rejected">
                                                <label class="form-check-label"
                                                    for="radio-switch-{{ $item->id }}-4">
                                                    Batal</label>
                                            </div>

                                            <div class="form-check mt-2 sm:mt-0">
                                                <input id="radio-switch-{{ $item->id }}-5"
                                                    class="form-check-input" type="radio"
                                                    name="status_{{ $item->id }}" value="Done" checked>
                                                <label class="form-check-label"
                                                    for="radio-switch-{{ $item->id }}-5">
                                                    Done</label>
                                            </div>
                                        </div>
                                    </div>
...
<div class="col-span-12 md:col-span-3">
    <button class="btn shadow-md w-full mb-2 text-white" style="background: rgb(44, 103, 232)"
        onclick="selesaiBedah()">
        <i class="fa-solid fa-head-side-mask mr-2"></i>Selesai Bedah</button>
    <button class="btn btn-warning shadow-md w-full mb-2 text-white" onclick="pasienMeninggal()"><i
        ...
        Meninggal</button>
    {{-- <button class="btn btn-danger shadow-md w-full mb-2 text-white"
        onclick="openModalData('#modal-di-tolak-bedah')"><i class="fa-solid fa-times mr-2"></i>Ditolak
        untuk bedah</button> --}}
    <div class="box mt-2">
        <div class="flex items-center col-span-12 border-b border-slate-200/60 dark:border-darkmode-400 px-3 py-2 text-left bg-warning rounded-t-lg"
            style="border-top-right-radius: 0.5rem !important;border-top-left-radius: 0.5rem !important;background: rgb(220, 18, 176)">
            <a href="javascript:;" class="font-medium text-white  w-full text-xl">Menu Bedah</a>
        </div>
