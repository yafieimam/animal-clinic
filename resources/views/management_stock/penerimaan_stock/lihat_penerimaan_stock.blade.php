    ...
    <form class="grid grid-cols-12 gap-6 mt-5" id="form-data">
        <div class="intro-y col-span-12">
            ...
            <div class="intro-y box p-5 grid grid-cols-12 gap-4 gap-y-3">
                ...
                <div class="col-span-12 md:col-span-6 parent">
                    <label for="tanggal_terima" class="form-label">Tanggal Input Barang {{ dot() }}</label>
                ...
                @if ($data->PengeluaranStock)
                    <div class="col-span-12 md:col-span-6 parent disabled">
                        <label class="form-label">Branch Pengirim <span style="color:red;font-weight:bold"
                                class="important">
                                *</span>
                        </label>
...
@section('script')
    <script>
        ...
        function initialiseData() {
            @if (!$data->PengeluaranStock)
                var newOption = new Option('{{ $data->Supplier->name }}',
                    '{{ $data->supplier_id }}',
                    true,
                    true
                );
