...
@section('content_filter')
    @include('../management_stock/mutasi_stock/filter_mutasi_stock')
@endsection
            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12 md:col-span-6 parent">
                        ...
                        <input type="text" id="qty" class="form-control" placeholder="Masukan Qty Stock"
                            name="qty">
                    </div>
                </div>
                <!-- END: Modal Body -->
    ...
    <script>
        ...
        (function() {
            table = $('#table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('datatableMutasiStock') }}",
                        data: {
                            _token: '{{ csrf_token() }}',
                            branch_id() {
        ...
        function requestStock(id, branchId, item) {
        ...
        function exportExcel() {
            ...
            var html = 'tanggal_awal=' + $('#tanggal_awal').val();
            html += '&tanggal_akhir=' + $('#tanggal_akhir').val();
            html += '&branch_id_filter=' + $('#branch_id_filter').val();
            html += '&jenis_item=' + $('#jenis_item').val();
            html += '&item_id=' + $('#item_id').val();
            window.open('{{ route('mutasiStockExcel') }}?' + html);
        }
    </script>
@endsection
