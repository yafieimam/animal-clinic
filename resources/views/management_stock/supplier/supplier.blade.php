        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12 md:col-span-6 parent">
                        <label for="email" class="form-label">Email {{ dot() }}</label>
                        <div class="input-group parent">
                    ...
                    <div class="col-span-12 md:col-span-6 parent">
                        <label for="npwp" class="form-label">NPWP {{ dot() }}</label>
                        <input id="npwp" name="npwp" type="text" class="form-control required"
                            placeholder="Masukan NPWP Supplier">
                    </div>
                    <div class="col-span-12 parent">
                        <label for="alamat" class="form-label">Alamat {{ dot() }}</label>
                        <textarea id="alamat" name="alamat" type="text" class="form-control required" placeholder="Masukan Alamat Lengkap"></textarea>
                    </div>
                </div>
                <!-- END: Modal Body -->
                <!-- BEGIN: Modal Footer -->
    ...
    <script>
        ...
        function generateKode() {
            if ($('#id').val() == '' && $('#binatang_id').val() != '') {
                $.ajax({
                    url: "{{ route('generateKodeSupplier') }}",
                    type: 'get',
                    data: {
                        binatang_id() {
