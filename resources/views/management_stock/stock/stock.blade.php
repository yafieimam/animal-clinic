...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">Stok</h2>
            ...
            <div class="flex flex-wrap items-center">
                @if (Auth::user()->akses('create'))
                    <a class="btn btn-primary shadow-md mr-2" id="tambah-data"
                        href="{{ route('createPenerimaanStock') }}">Tambah Data Stok</a>
                @endif
            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-12 md:col-span-6 parent">
                        ...
                        <input type="text" id="qty" class="form-control required" placeholder="Masukan Jumlah Stok"
                            name="qty">
                    </div>
                </div>
                <!-- END: Modal Body -->
