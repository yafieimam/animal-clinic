            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Kategori Obat {{ dot() }}</label>
    ...
    <script>
        ...
        (function() {
            table = $('#table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('datatableKategoriObat') }}",
                        data: {
                            _token: '{{ csrf_token() }}'
                        }
                    },
