            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="kode" class="form-label">Kode Satuan Obat {{ dot() }}</label>
                        <input id="kode" name="kode" type="text"
                            class="form-control uppercase required not-editable" placeholder="Masukan Kode Satuan Obat">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Satuan Obat {{ dot() }}</label>
                        <input id="name" name="name" type="text" class="form-control uppercase required"
                            placeholder="Masukan Nama Satuan Obat">
                    </div>
