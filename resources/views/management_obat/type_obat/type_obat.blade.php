...
@section('subcontent')
    ...
    <h2 class="intro-y text-lg font-medium mt-10">Sediaan Obat</h2>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="kode" class="form-label">Kode Sediaan Obat {{ dot() }}</label>
                        <input id="kode" name="kode" type="text" class="form-control uppercase required not-editable"
                            placeholder="Masukan Kode Sediaan Obat">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Sediaan Obat {{ dot() }}</label>
                        <input id="name" name="name" type="text" class="form-control uppercase required"
                            placeholder="Masukan nama Sediaan Obat">
                    </div>
