...
<div class="col-span-12 mb-3">
    <label for="type_kasir_filter" class="form-label">Filter Type Kasir</label>
    <select name="type_kasir_filter" id="type_kasir_filter" class="select2filter form-control w-full">
        <option value="">Semua Type Kasir</option>
            <option value="Rescue an MMI">Rescue an MMI</option>
            <option value="Rescue an Clow">Rescue an Clow</option>
