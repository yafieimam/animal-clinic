...
@section('subcontent')
    ...
    <div id="modal-cancel-data" class="modal" data-tw-backdrop="static" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <!-- BEGIN: Modal Header -->
                <div class="modal-header">
                ...
                <!-- END: Modal Header -->
                <!-- BEGIN: Modal Body -->
                <form class="modal-body grid grid-cols-12 gap-4 gap-y-3 " id="form-cancel-data">
                    <div class="col-span-12 parent disabled">
                        <label for="owner_id_cancel" class="form-label">Owner</label>
                        <select name="owner_id_cancel" id="owner_id_cancel" class="select2 form-control required">
                            <option value="">Pilih Owner</option>
                            @foreach (\App\Models\Owner::get() as $item)
                                <option value="{{ $item->id }}">{{ $item->kode }} - {{ $item->name }}</option>
                            @endforeach
                        </select>
                        <input type="hidden" id="deposit_id_cancel" name="deposit_id_cancel">
                        <input type="hidden" id="id_cancel" name="id_cancel">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent">
                        <label for="nominal_transfer_cancel" class="form-label">Nominal Transfer
                        </label>
                        <input id="nominal_transfer_cancel" readonly name="nominal_transfer_cancel" type="text"
                            class="form-control text-left required">
                    </div>
                    <div class="col-span-12 parent disabled">
                        <label for="metode_pembayaran_cancel" class="form-label">Metode Pembayaran</label>
                        <select name="metode_pembayaran_cancel" id="metode_pembayaran_cancel" class="form-control">
                            <option value="TUNAI">TUNAI</option>
                            <option value="DEBET">DEBET</option>
                            <option value="TRANSFER">TRANSFER</option>
                        </select>
                    ...
                    <div class="col-span-6 parent non-tunai hidden">
                        <label for="nama_bank_cancel" class="form-label">Nama Bank</label>
                        <input id="nama_bank_cancel" name="nama_bank_cancel" type="text"
                            class="form-control text-left uppercase required" readonly placeholder="Masukan nama bank">
                    </div>
                    <div class="col-span-6 parent non-tunai hidden">
                        <label for="nomor_kartu_cancel" class="form-label">No. Rekening</label>
                        <input type="text" name="nomor_kartu_cancel" id="nomor_kartu_cancel" readonly placeholder="xxxxxxxxxx"
                            class="form-control required">
                    </div>
                    <div class="col-span-12 parent non-tunai hidden">
                        <label for="atas_nama_cancel" class="form-label">Atas Nama</label>
                        <input type="text" name="atas_nama_cancel" id="atas_nama_cancel" readonly
                            placeholder="Masukan Nama di Rekening" class="form-control required">
                    </div>
                    <div class="col-span-12 parent">
                        <label for="keterangan_cancel" class="form-label">Keterangan / Alasan {{ dot() }}</label>
                        <textarea id="keterangan_cancel" name="keterangan_cancel" type="text" class="form-control required" placeholder="Masukan Keterangan"></textarea>
                    </div>
                </form>
                <!-- END: Modal Body -->
                <!-- BEGIN: Modal Footer -->
                <div class="modal-footer">
                    <button type="button" data-tw-dismiss="modal"
                        class="btn btn-outline-secondary w-20 mr-1">Batal</button>
                    <button type="button" class="btn btn-primary" onclick="prosesCancel()">Simpan</button>
                </div>
                <!-- END: Modal Footer -->
            </div>
        </div>
