        ...
        <div class="col-span-12 racikan-child racikan">
            <div class="grid grid-cols-12 gap-2">
                <div class="col-span-12 md:col-span-6 parent">
                    ...
                    <select name="jenis_obat_racikan[]" class="jenis_obat_racikan form-control required select2filter">
            ...
            <div class="grid grid-cols-12 gap-2">
                <div class="col-span-8 parent">
                    ...
                    <select name="produk_obat_non_racikan[]"
                        class="produk_obat_non_racikan form-control required select2filter">
                        <option value="">Pilih Jenis Obat</option>
