...
@section('subcontent')
    <div class="intro-y md:flex md:justify-between items-center mt-8">
        <span class="text-lg font-medium">Daftar Antrean</span>
            ...
            <div class="box col-span-12">
                <div class="intro-y col-span-12 md:col-span-6 xl:col-span-4">
                    <div class="flex items-center  border-b border-slate-200/60 dark:border-darkmode-400 px-5 py-4 text-center bg-primary rounded-t-lg"
                        ...
                        <i class="fa-solid fa-expand text-white" style="cursor: pointer" onclick="openFullscreen()"></i>
                    </div>
                    <div class="p-5">
...
@section('script')
    <script>
        ...
        function openFullscreen(params) {
            window.open('{{ route('fullscreenMonitoringAntrian') }}?branch_id=' + $('#branch_id').val());
        }
    </script>
@endsection
