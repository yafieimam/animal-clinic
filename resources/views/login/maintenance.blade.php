<style type="text/css">
    ...
    * {
    ...
    {{-- <meta name="csrf-token" content="{{ csrf_token() }}"> --}}
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('dist/images/amore.png') }}">
    <title>Amore Animal Clinic</title>
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('dist/images/amore.png') }}">
    <main>
    
      <section class="advice">
        <h1 class="advice__title">Sorry for the inconvenience but we&rsquo;re performing some maintenance at the moment. If you need to you can always <a href="mailto:ithelpdesk@gudanggaramtbk.com">contact us</a>, otherwise we&rsquo;ll be back online shortly! </h1>
        <p class="advice__description">&mdash; The Team</p>
