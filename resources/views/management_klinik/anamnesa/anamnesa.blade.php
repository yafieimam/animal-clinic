            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Anamnesa {{ dot() }}</label>
                        <input id="name" name="name" type="text" class="form-control required"
                            placeholder="Masukan Nama Anamnesa">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent">
                        <label for="poli_id" class="form-label">Poli {{ dot() }}</label>
                        <select id="poli_id" name="poli_id" type="text" class="form-control required select2">
                            <option selected value="semua">Semua Poli</option>
    ...
    <script>
        ...
        (function() {
            ...
            $('#tambah-data').click(function() {
                ...
                $('#poli_id').val('semua').trigger('change.select2');
