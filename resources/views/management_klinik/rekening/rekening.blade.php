            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Rekening {{ dot() }}</label>
                        <input id="name" name="name" type="text" class="form-control required"
                            placeholder="Masukan Nama Rekening">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent {{ Auth::user()->akses('global') ? '' : 'disabled' }}">
                    ...
                    <div class="col-span-12 md:col-span-6 parent">
                        <label for="bank" class="form-label">Nama Bank {{ dot() }}</label>
                        <input id="bank" name="bank" type="text"
                            class="form-control text-left uppercase required" placeholder="Masukan nama bank">
                    </div>
                    <div class="col-span-12 md:col-span-6 parent">
                        <label for="no_rekening" class="form-label">No. Rekening {{ dot() }}</label>
                        <input type="text" name="no_rekening" id="no_rekening" placeholder="xxxxxxxxxx"
