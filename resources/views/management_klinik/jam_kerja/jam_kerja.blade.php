        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-header">
                    <h2 class="font-medium text-base mr-auto">Tambah Jam Kerja</h2>
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="jam_awal" class="form-label">Jam Kerja</label>
                        <input id="jam_awal" name="jam_awal" type="text"
                            class="form-control uppercase required timeMask text-center" placeholder="08:00">
                        {{ csrf_field() }}
