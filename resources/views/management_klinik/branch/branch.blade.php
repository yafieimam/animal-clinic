            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="kode" class="form-label">Kode Branch {{ dot() }}</label>
                        <input id="kode" name="kode" type="text" maxlength="3"
                            class="form-control uppercase required not-editable" placeholder="Masukan Kode Branch">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent">
                        <label for="lokasi" class="form-label">Lokasi {{ dot() }}</label>
                        <input id="lokasi" name="lokasi" type="text" class="form-control required"
                            placeholder="Masukan Lokasi Branch">
                    </div>
                    <div class="col-span-12 parent">
                    ...
                    <div class="col-span-6 parent">
                        <label for="open_time" class="form-label">Jam Buka {{ dot() }}</label>
                        <input id="open_time" name="open_time" type="text" class="form-control timeMask required">
                    </div>
                    <div class="col-span-6 parent">
                        <label for="close_time" class="form-label">Jam Tutup {{ dot() }}</label>
                        <input id="close_time" name="close_time" type="text" class="form-control timeMask required">
                    </div>
                    <div class="col-span-12 parent">
                        <label for="hari_libur" class="form-label">Hari Libur {{ dot() }}</label>
                        <select id="hari_libur" name="hari_libur" class="w-full select2 required form-control"
                    ...
                    <div class="col-span-6 parent">
                        <label for="open_holiday_time" class="form-label">Jam Buka Hari Libur {{ dot() }}</label>
                        <input id="open_holiday_time" name="open_holiday_time" type="text"
                            class="form-control timeMask required">
                    </div>
                    <div class="col-span-6 parent">
                        <label for="close_holiday_time" class="form-label">Jam Tutup Hari Libur
                            {{ dot() }}</label>
                        <input id="close_holiday_time" name="close_holiday_time" type="text"
                            class="form-control timeMask required">
                    </div>
                </div>
                <!-- END: Modal Body -->
