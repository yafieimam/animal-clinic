...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Jenis Ruang Rawat Inap</h2>
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        ...
                        <input id="name" name="name" type="text" class="form-control required"
                            placeholder="Masukan Nama Ruang Rawat Inap">
    ...
    <script>
        ...
        (function() {
            table = $('#table').DataTable({
                    ...
                    ajax: {
                        url: "{{ route('datatableKategoriKamar') }}",
                        data: {
                            _token: '{{ csrf_token() }}'
                        }
                    },
