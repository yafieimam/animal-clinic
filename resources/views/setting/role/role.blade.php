            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Role {{ dot() }}</label>
                        <input id="name" name="name" type="text"
                            class="form-control uppercase required not-editable" placeholder="Tulis Nama Role">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-12 parent">
                        <label for="type_role" class="form-label">Jenis Role {{ dot() }}</label>
                        <select id="type_role" name="type_role" class="w-full select2 required form-control">
                            <option value="">Pilih Jenis Role</option>
                            @foreach (\App\Models\Role::$enumTypeRole as $item)
