...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Group Menu</h2>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    <div class="col-span-12 parent">
                        <label for="name" class="form-label">Nama Group {{ dot() }}</label>
                        <input id="name" name="name" type="text" class="form-control uppercase required"
                            placeholder="Masukan nama group">
                        <input type="hidden" id="id" name="id">
                        {{ csrf_field() }}
                    </div>
                    <div class="col-span-6 parent">
                        <label for="open_time" class="form-label">Icon Menu {{ dot() }}</label>
                        <div class="input-group parent">
                            <div class="input-group-text" id="append-icon"></div>
                            <input id="icon" name="icon" type="text" class="form-control required"
                                placeholder="Masukan Icon Fontawesome 6">
                        </div>
                    </div>
                    <div class="col-span-6 parent">
                        <label for="title_menu_id" class="form-label">Title Menu {{ dot() }}</label>
                        <select id="title_menu_id" name="title_menu_id" class="w-full select2 required form-control">
                    ...
                    <div class="col-span-6 parent">
                        ...
                        <select id="type" name="type" class="w-full select2 required form-control">
                    ...
                    <div class="col-span-6 parent">
                        ...
                        <input id="slug" name="slug" type="text" class="form-control required" placeholder="Masukan Slug">
                    </div>
                    <div class="col-span-12 parent">
                        <label for="url" class="form-label">Url</label>
                        <input id="url" name="url" type="text" class="form-control" placeholder="Masukan Url">
                    </div>
                    <div class="col-span-12 parent">
                        <label for="description" class="form-label">Keterangan</label>
                        <textarea id="description" name="description" placeholder="Masukan keterangan" type="text"
