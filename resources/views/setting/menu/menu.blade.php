...
@section('subcontent')
    <h2 class="intro-y text-lg font-medium mt-10">Menu</h2>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body grid grid-cols-12 gap-4 gap-y-3">
                    ...
                    <div class="col-span-6 parent">
                        ...
                        <select id="group_menu_id" name="group_menu_id" class="w-full select2 required form-control">
                    ...
                    <div class="col-span-12 parent">
                        <label for="url" class="form-label">Url {{ dot() }}</label>
                        <input id="url" name="url" type="text" class="form-control required" placeholder="Masukan Url">
                    </div>
                    <div class="col-span-12 parent">
                        <label for="type" class="form-label">Type {{ dot() }}</label>
                        <select id="type" name="type" class="w-full select2 required form-control">
                            <option value="">Pilih Type</option>
                            <option value="MENU">MENU</option>
                            <option value="SUB MENU">SUB MENU</option>
                            <option value="SINGLE MENU">SINGLE MENU</option>
