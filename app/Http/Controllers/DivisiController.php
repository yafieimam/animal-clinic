...
class DivisiController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('management_klinik/divisi/divisi');
    }

    public function datatable(Request $req)
    {
        $data = $this->model->divisi()->all();

        return Datatables::of($data)
            ->addColumn('aksi', function ($data) {
                return view('management_klinik/divisi/action_button_divisi', compact('data'));
            })
    ...
    public function store(Request $req)
    {
        return DB::transaction(function () use ($req) {
            ...
            if ($req->id == null or $req->id == 'null' or $req->id == '') {
                ...
                $input['id'] = $this->model->divisi()->max('id') + 1;
                ...
                $this->model->divisi()->create($input);
                ...
                $this->model->divisi()->find($req->id)->update($input);
    ...
    public function status(Request $req)
    {
        ...
        return DB::transaction(function () use ($req) {
            $this->model->divisi()->where('id', $req->id)
                ->update([
                    'status' => $req->param
                ]);
    ...
    public function edit(Request $req)
    {
        ...
        $data = $this->model->divisi()->where('id', $req->id)->first();
    ...
    public function delete(Request $req)
    {
        return DB::transaction(function () use ($req) {
            ...
            try {
                $this->model->divisi()->find($req->id)->delete();
            } catch (\Throwable $th) {
